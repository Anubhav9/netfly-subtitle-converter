        ...
        if current_subtitle!=previous_subtitle:
            if i==len(subtitles_list)-1 :
                ...
                new_json = {
                    ...
                    "original_text":subtitles_list[i]["original_text"],
                ...
                new_json={
                    ...
                    "original_text":subtitles_list[i-1]["original_text"],
            ...
            if i==len(subtitles_list)-1:
                logging.info("Since we have reached the end of the subtitle [ same ] , hence we need to handle it explicitly")
                new_json = {
